...
# #             os.path.join(os.path.dirname(__file__), 'sam')]
# for pth in prj_path:
...
from helper_function import read_multi_object


class SegTracker():
    def __init__(self,io_args,segtracker_args, sam_args, aot_args) -> None:
        """
    ...
    def seg(self,frame):
        ...
        self.origin_merged_mask = read_multi_object(self.path)
        '''
        idx = 1
        for ann in anns:
